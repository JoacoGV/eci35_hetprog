...
// SystemVerilog created from i_sfc_logic_s_c1_in_ztszz4mainenkulrn2cl4sycl7handleree1_cles2_e7sum_a_bs_c1_enter_k0_ztszz4mainenkulrn2cl4sycl7handleree1_cles2_e7sum_a_b0
...
module k0_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE1_000bee1_cles2_e7sum_a_b0 (
    output wire [0:0] out_c1_exi1_0_tpl,
    output wire [31:0] out_c1_exi1_1_tpl,
    output wire [0:0] out_o_valid,
    output wire [0:0] out_unnamed_k0_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE1_clES2_E7sum_a_b2,
    ...
    wire [0:0] GND_q;
    wire [0:0] VCC_q;
    wire [31:0] i_unnamed_k0_ztszz4mainenkulrn2cl4sycl7handleree1_cles2_e7sum_a_b2_out_primWireOut;
    ...
    // i_unnamed_k0_ztszz4mainenkulrn2cl4sycl7handleree1_cles2_e7sum_a_b2(BLACKBOX,3)@59
    // out out_primWireOut@64
    k0_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE1_0000oucqdq06oucqd006ou0z thei_unnamed_k0_ztszz4mainenkulrn2cl4sycl7handleree1_cles2_e7sum_a_b2 (
        .in_0(in_c1_eni2_1_tpl),
        .in_1(in_c1_eni2_2_tpl),
        .out_primWireOut(i_unnamed_k0_ztszz4mainenkulrn2cl4sycl7handleree1_cles2_e7sum_a_b2_out_primWireOut),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    assign out_c1_exi1_1_tpl = i_unnamed_k0_ztszz4mainenkulrn2cl4sycl7handleree1_cles2_e7sum_a_b2_out_primWireOut;
    assign out_o_valid = redist0_sync_together7_aunroll_x_in_i_valid_5_q;
    assign out_unnamed_k0_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE1_clES2_E7sum_a_b2 = GND_q;
