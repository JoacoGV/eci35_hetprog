...
(
   ...
   output logic [32:0] kernel_ddr4a_address,
   ...
   output logic [32:0] kernel_ddr4b_address,
   ...
   // AVM kernel_ddr4c
   output logic kernel_ddr4c_enable,
   output logic kernel_ddr4c_read,
   output logic kernel_ddr4c_write,
   output logic [32:0] kernel_ddr4c_address,
   output logic [511:0] kernel_ddr4c_writedata,
   output logic [63:0] kernel_ddr4c_byteenable,
   input logic kernel_ddr4c_waitrequest,
   input logic [511:0] kernel_ddr4c_readdata,
   input logic kernel_ddr4c_readdatavalid,
   output logic [15:0] kernel_ddr4c_burstcount,
   input logic kernel_ddr4c_writeack,
   // AVM kernel_ddr4d
   output logic kernel_ddr4d_enable,
   output logic kernel_ddr4d_read,
   output logic kernel_ddr4d_write,
   output logic [32:0] kernel_ddr4d_address,
   output logic [511:0] kernel_ddr4d_writedata,
   output logic [63:0] kernel_ddr4d_byteenable,
   input logic kernel_ddr4d_waitrequest,
   input logic [511:0] kernel_ddr4d_readdata,
   input logic kernel_ddr4d_readdatavalid,
   output logic [15:0] kernel_ddr4d_burstcount,
   input logic kernel_ddr4d_writeack,
   ...
   // INST mul_array_sycl_optimized_4917b8_903df0_sys of mul_array_sycl_optimized_4917b8_903df0_sys
   mul_array_sycl_optimized_4917b8_903df0_sys mul_array_sycl_optimized_4917b8_903df0_sys
   (
      ...
      .avm_mem_gmem_0_DDR_port_2_0_rw_enable(kernel_ddr4c_enable),
      .avm_mem_gmem_0_DDR_port_2_0_rw_read(kernel_ddr4c_read),
      .avm_mem_gmem_0_DDR_port_2_0_rw_write(kernel_ddr4c_write),
      .avm_mem_gmem_0_DDR_port_2_0_rw_address(kernel_ddr4c_address),
      .avm_mem_gmem_0_DDR_port_2_0_rw_writedata(kernel_ddr4c_writedata),
      .avm_mem_gmem_0_DDR_port_2_0_rw_byteenable(kernel_ddr4c_byteenable),
      .avm_mem_gmem_0_DDR_port_2_0_rw_waitrequest(kernel_ddr4c_waitrequest),
      .avm_mem_gmem_0_DDR_port_2_0_rw_readdata(kernel_ddr4c_readdata),
      .avm_mem_gmem_0_DDR_port_2_0_rw_readdatavalid(kernel_ddr4c_readdatavalid),
      .avm_mem_gmem_0_DDR_port_2_0_rw_burstcount(kernel_ddr4c_burstcount),
      .avm_mem_gmem_0_DDR_port_2_0_rw_writeack(kernel_ddr4c_writeack),
      // AVM avm_mem_gmem_0_DDR_port_3_0_rw
      .avm_mem_gmem_0_DDR_port_3_0_rw_enable(kernel_ddr4d_enable),
      .avm_mem_gmem_0_DDR_port_3_0_rw_read(kernel_ddr4d_read),
      .avm_mem_gmem_0_DDR_port_3_0_rw_write(kernel_ddr4d_write),
      .avm_mem_gmem_0_DDR_port_3_0_rw_address(kernel_ddr4d_address),
      .avm_mem_gmem_0_DDR_port_3_0_rw_writedata(kernel_ddr4d_writedata),
      .avm_mem_gmem_0_DDR_port_3_0_rw_byteenable(kernel_ddr4d_byteenable),
      .avm_mem_gmem_0_DDR_port_3_0_rw_waitrequest(kernel_ddr4d_waitrequest),
      .avm_mem_gmem_0_DDR_port_3_0_rw_readdata(kernel_ddr4d_readdata),
      .avm_mem_gmem_0_DDR_port_3_0_rw_readdatavalid(kernel_ddr4d_readdatavalid),
      .avm_mem_gmem_0_DDR_port_3_0_rw_burstcount(kernel_ddr4d_burstcount),
      .avm_mem_gmem_0_DDR_port_3_0_rw_writeack(kernel_ddr4d_writeack),
